...
namespace DCXR.CSVManagerDemo
{
    public class Demo1 : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            Debug.Log($"File load from: {Application.dataPath}/../CSV/TechCrunchcontinentalUSA.csv");

            // load
            manager.GetDatabase("csv").LoadFromFile($"{Application.dataPath}/../CSV", "TechCrunchcontinentalUSA.csv");
            ...
            // save
            manager.GetDatabase("mycsv").SaveToFile($"{Application.dataPath}/../CSV", "save.csv");
            Debug.Log($"File saved to: {Application.dataPath}/../CSV/save.csv");
        }
